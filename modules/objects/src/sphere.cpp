...
sphere::sphere(const point3& static_center, double _radius, std::shared_ptr<material> _mat) : 
  center(static_center, vec3(0, 0, 0)), radius(std::max(0.001, _radius)), mat(std::move(_mat)){
